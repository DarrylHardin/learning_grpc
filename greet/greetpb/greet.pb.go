...
func (*Greeting) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_95287d20fb4769ff, []int{0}
}
...
func (*GreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_95287d20fb4769ff, []int{1}
}
...
func (*GreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_95287d20fb4769ff, []int{2}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_95287d20fb4769ff, []int{3}
}
...
func (*GreetManyTimesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_95287d20fb4769ff, []int{4}
}
...
func init() { proto.RegisterFile("greet/greetpb/greet.proto", fileDescriptor_greet_95287d20fb4769ff) }

var fileDescriptor_greet_95287d20fb4769ff = []byte{
